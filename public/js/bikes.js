$(document).ready(function() {
    ...
    // InitializeRows handles appending all of our constructed bike HTML inside appContainer
    ...
    function displayEmpty(id) {
      ...
      messageh2.html("No bikes yet" + partial + ", navigate <a href='/cms" + query +
      "'>here</a> in order to get started.");
      appContainer.append(messageh2);
    }
